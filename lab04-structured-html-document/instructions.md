...
<article>
    ...
    <h2>your third section</h2>
    
</article>

<aside>  
    <h2>your fourth section with lists</h2>
...
```
Note: In the places with the placeholder content (in the H1 and H2syou need to replace that with your own words, and then fill in the rest of your content - marked-up with HTML tags - in the appropriate places
